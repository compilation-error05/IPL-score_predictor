...
overs = st.number_input('Enter the number of overs bowled', min_value=5.0, max_value=20.0, step=0.1)
runs = st.number_input('Enter the number of runs scored', min_value=0)
wickets = st.number_input('Enter the number of wickets lost', min_value=0, max_value=10)
runs_last_5 = st.number_input('Enter the runs scored in the last 5 overs', min_value=0)
